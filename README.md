...
| 자동 기동 | launchd `com.supermemory.local` (로그인 시 + 크래시 재시작) |
...
# 수동 재시작 / 중지
launchctl kickstart -k gui/$(id -u)/com.supermemory.local
launchctl unload ~/Library/LaunchAgents/com.supermemory.local.plist
